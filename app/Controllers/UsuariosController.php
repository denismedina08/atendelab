...
class UsuariosController
{
    ...
    public function listar(): void
    {
        ...
        echo json_encode(['usuarios' => $usuarios], JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    }
    ...
    public function criar(): void
    {
        ...
        // Armazena senha em Hash - Nunca em texto puro
    ...
    public function inativar(): void
    {
        ...
        // Não deixa inativar a própria conta.
        $atual = usuarioAtual();
        if ((int) $atual['id'] === $id) {
            http_response_code(400);
            echo json_encode(['erro' => 'Você não pode inativar sua própria conta.']);
            return;
        }
