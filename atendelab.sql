...
--
-- Host: 127.0.0.1:3307
-- Tempo de geração: 10/06/2026 às 02:48
...
INSERT INTO `atendimentos` (`id`, `pessoa_id`, `tipo_atendimento_id`, `usuario_id`, `observacao`, `data_atendimento`) VALUES
(1, 1, 1, 1, 'Atendimento realizado para atualização cadastral.', '2026-06-09 21:44:25');
...
INSERT INTO `pessoas` (`id`, `nome`, `cpf`, `telefone`, `email`, `criado_em`) VALUES
(1, 'Maria Silva', '123.456.789-00', '(47)99999-9999', 'maria@email.com', '2026-06-10 00:44:05');
...
INSERT INTO `tipos_atendimentos` (`id`, `descricao`, `status`) VALUES
(1, 'Informação', 'ativo');
...
(1, 'Administrador', 'admin@atendelab.com', '$2y$10$J9P2kU2BAMZ3TZcuxTsW4e1D/lka8EocYHzvyoOZmCNcWDQz3RuVC', 'admin', 'ativo', '2026-06-09 23:58:47'),
(2, 'João Teste Atualizado', 'joao.teste@atendelab.com', '$2y$10$0.WFLtl1xLl1eG1vd8IoO.jzwk9IPFjxw8kZ8Kt9n9OWIcXfo6yTe', 'atendente', 'ativo', '2026-06-10 00:27:30');
