// ponte entre as telas e o backend
window.AtendeLabApi = (() => {
    ...
    // tenta pegar a lista independente do nome da chave retornada
    ...
    function showAlert(id, message, type = 'success') {
        ...
        if (!el) return;
        el.innerHTML = `<div class="alert alert-${escape(type)} alert-dismissible fade show" role="alert">
            ${escape(message)}
